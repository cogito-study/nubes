# Migration `20190801135018-init`

This migration has been generated by kiralybalint <balint.kiraly@cogito.study> at 8/1/2019, 1:50:18 PM.
...
You can use a specific Photon built for this migration (20190801135018-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190801135018-init'
