# Migration `20191127191141-re-init`

This migration has been generated by kiralybalint <balint.kiraly@cogito.study> at 11/27/2019, 7:11:41 PM.
...
ADD COLUMN "departmentPermission" text   REFERENCES "public"."DepartmentPermission"("id") ON DELETE SET NULL,
ADD COLUMN "institutePermission" text   REFERENCES "public"."InstitutePermission"("id") ON DELETE SET NULL,
...
ADD COLUMN "notePermission" text   REFERENCES "public"."NotePermission"("id") ON DELETE SET NULL,
ADD COLUMN "postCommentPermission" text   REFERENCES "public"."PostCommentPermission"("id") ON DELETE SET NULL,
...
You can use a specific Photon built for this migration (20191127191141-re-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191127191141-re-init'
